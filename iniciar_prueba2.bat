@echo off
title Iniciar Prueba Interactiva de Matemáticas - Guia 2
echo.
echo =========================================================
echo   Iniciando Servidor de la Prueba 2 de Matemáticas...
echo =========================================================
echo.
...
echo Iniciando aplicación web para la Guía 2...
call .venv\Scripts\activate.bat
